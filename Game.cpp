...
int ekran1mm;
cout<<"Wybierz opcje MENU"<<endl;
cout<<"[1]- Zabij Gospodarza(to moze byc niebezpieczne..)"<<endl<<"[2]- Menu(niestabilne)"<<endl<<"[3]- Pokasz mi swoje towary.."<<endl;
cin>>ekran1mm;
...
SetConsoleTextAttribute( kolor, 4);
    ...
    cout<<"                                                Zycie Gospodarza"<<sbohatera[0]--*GOSPODARZ[1]<<endl<<endl;
    Sleep(400);
}
...
cout<<"                                                   Twoje zycie!!!"<<GOSPODARZ[0]--*sbohatera[1]<<endl;
 Sleep(400);
}
...
case 2:
    ...
    //...
case 3:
    cout<<"Nie mam nic dla ciebie w tym momencie.."<<endl;
...
system("cls");
 fstream plik6("ekran7.txt", ios::in);
string dane6;
if(plik.good()==false)
{
    cout<<"Plik nie istnieje!"<<endl;
...
system("cls");
 fstream plik7("ekran8.txt", ios::in);
string dane7;
if(plik.good()==false)
{
    cout<<"Plik nie istnieje!"<<endl;
...
system("cls");
 fstream plik8("ekran9.txt", ios::in);
string dane8;
if(plik.good()==false)
{
    cout<<"Plik nie istnieje!"<<endl;
...
system("cls");
 fstream plik9("ekran10.txt", ios::in);
string dane9;
if(plik.good()==false)
{
    cout<<"Plik nie istnieje!"<<endl;
